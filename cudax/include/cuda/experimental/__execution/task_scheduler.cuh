...
template <class _Rcvr, class _Value, class _Query, bool _Nothrow>
constexpr auto __try_query_vfn<_Rcvr, _Value(_Query) noexcept(_Nothrow)> =
  &__try_query_vfn_impl<_Rcvr, _Value, _Query, _Nothrow>;
...
struct __ircvr
{
  ...
  struct __iface : __basic_interface<__iface>
  {
    ...
    {
      ::cuda::__virtcall<&__complete_vfn<__iface, set_value_t>>(this);
    }

    _CCCL_EXEC_CHECK_DISABLE
    _CCCL_API void set_error(::std::exception_ptr&& __eptr) noexcept
    {
      ::cuda::__virtcall<&__complete_vfn<__iface, set_error_t, ::std::exception_ptr&&>>(this, _CCCL_MOVE(__eptr));
    }

    _CCCL_API void set_stopped() noexcept
    {
      ::cuda::__virtcall<&__complete_vfn<__iface, set_stopped_t>>(this);
    }
    ...
    using overrides =
      __overrides_for<_Rcvr,
                      &__complete_vfn<_Rcvr, set_value_t>,
                      &__complete_vfn<_Rcvr, set_error_t, ::std::exception_ptr&&>,
                      &__complete_vfn<_Rcvr, set_stopped_t>,
...
using __task_opstate_for = connect_result_t<_Sndr, __default_task_receiver_ref>;

// The "virtual function" for `connect` on a __task_sender.
template <class _Sndr>
[[nodiscard]] _CCCL_PUBLIC_API auto __connect_vfn(_Sndr& __sndr, __default_task_receiver_ref __rcvr)
  -> __basic_any<__iopstate<>>
{
  return __basic_any<__iopstate<>>{
    ::cuda::in_place_from_type<__task_opstate_for<_Sndr>>,
    execution::connect,
...
struct __any_opstate
{
  ...
  _CCCL_API __any_opstate(_ISndr* __isndr, _Rcvr __rcvr)
      ...
      // The following *should* work, but NVCC cannot elide the move here.
      //, __opstate_(::cuda::__virtcall<&__connect_vfn<_ISndr>>(__isndr, __default_task_receiver_ref(__rcvr_)))
      , __opstate_(::cuda::in_place_from_type<__basic_any<__iopstate<>>>, [&] {
        return ::cuda::__virtcall<&__connect_vfn<_ISndr>>(__isndr, __default_task_receiver_ref(__rcvr_));
      })
  {}
...
template <class _Sch>
_CCCL_PUBLIC_API auto __schedule_bulk_chunked_vfn(_Sch& __sch, size_t __size, __bulk_item_receiver_ref __rcvr) noexcept
  -> __basic_any<__iopstate<>>;

// The "virtual function" for task_scheduler::__schedule_bulk(bulk_unchunked_t, ...)
template <class _Sch>
_CCCL_PUBLIC_API auto __schedule_bulk_unchunked_vfn(_Sch& __sch, size_t __size, __bulk_item_receiver_ref __rcvr) noexcept
  -> __basic_any<__iopstate<>>;
...
struct __itask_scheduler : __basic_interface<__itask_scheduler, __extends<__icopyable<>, __iequality_comparable<>>>
{
  ...
  _CCCL_API auto __schedule_bulk(bulk_chunked_t, size_t __size, __bulk_item_receiver_ref __rcvr) noexcept
    -> __basic_any<__iopstate<>>
  {
    return ::cuda::__virtcall<&__schedule_bulk_chunked_vfn<__itask_scheduler>>(this, __size, __rcvr);
  }

  _CCCL_API auto __schedule_bulk(bulk_unchunked_t, size_t __size, __bulk_item_receiver_ref __rcvr) noexcept
    -> __basic_any<__iopstate<>>
  {
    return ::cuda::__virtcall<&__schedule_bulk_unchunked_vfn<__itask_scheduler>>(this, __size, __rcvr);
  }

  _CCCL_TEMPLATE(class _Sndr, class _Env)
  _CCCL_REQUIRES(sender_in<_Sndr, _Env>)
...
struct __task_sender : __basic_any<__itask_sender<>>
{
  ...
  _CCCL_API __task_sender(_Sndr __sndr, task_scheduler __sch)
      : __basic_any<__itask_sender<>>{static_cast<_Sndr&&>(__sndr)}
      , __env_{{}, _CCCL_MOVE(__sch)}
  {}

  _CCCL_API __task_sender(__task_sender&& __other, task_scheduler __sch) noexcept
...
struct __task_bulk_receiver
{
  ...
  _CCCL_API void set_value(_As&&... __as) noexcept
  {
    _CCCL_TRY
    {
      ...
      auto __mk_opstate = [this]() -> __basic_any<__iopstate<>> {
        return __state_->__sch_.__schedule_bulk(_BulkTag{}, __state_->__shape_, __bulk_item_receiver_ref{*__state_});
      };
      auto& __op = __state_->__opstate2_.template emplace_from<__basic_any<__iopstate<>>>(__mk_opstate);
      __op.start();
    }
    _CCCL_CATCH_ALL
    {
...
struct __task_bulk_sender
{
  ...
  [[nodiscard]] _CCCL_API static _CCCL_CONSTEVAL auto get_completion_signatures()
  {
    ...
    return _Sndr::template get_completion_signatures<_Sndr, _Env>() + __eptr_completion();
  }
  ...
  -> __basic_any<__iopstate<>>
{
  _CCCL_TRY
  {
    ...
    return __basic_any<__iopstate<>>{
      ::cuda::in_place_from_type<__opstate_t>, execution::connect, static_cast<__sndr_t&&>(__sndr), _CCCL_MOVE(__rcvr)};
  }
  _CCCL_CATCH_ALL
  {
    return __error_opstate{__rcvr, ::std::current_exception()};
  }
}
